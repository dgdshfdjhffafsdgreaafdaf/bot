...
if (message.content.startsWith('!bcall')){
 if (message.author.id !== '430038396585377793') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '430038396585377793') return;
...
m.sendMessage(args)
 ...
 client.on('message' , function (message){
      var token = 'NDY5OTU2MzIxOTc0OTQzNzQ0.DzYN6A.rPvYoL_zQ_ty1sstUdHiPpkCFXU'; // التوكن هنا بس
      if(message.content === '!restart') {
if(message.author.id !== '430038396585377793') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
          client.destroy();
...
client.login('NDY5OTU2MzIxOTc0OTQzNzQ0.DzYN6A.rPvYoL_zQ_ty1sstUdHiPpkCFXU'); 